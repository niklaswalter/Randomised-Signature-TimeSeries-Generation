...
class Evaluation:
    ...
    def print_summary(self):
        file = open("/content/drive/MyDrive/ColabNotebooks/Code_RSig_Gen/Conditional_Generator/evaluation/{}/{}-{}-{}.txt".format(self.data_type, self.generator_id, self.discriminator_id,
    ...
    def save_best_generator(self):
        torch.save(self.best_generator.state_dict(), "/content/drive/MyDrive/ColabNotebooks/Code_RSig_Gen/Conditional_Generator/best_generators/{}/{}-{}-{}-{}-{}.pt".
    ...
    def save_paths(self):
        torch.save(self.x_fake_train.detach(), "/content/drive/MyDrive/ColabNotebooks/Code_RSig_Gen/Conditional_Generator/best_generators/{}/{}-{}-{}-{}-{}-fake.pt".
                   format(self.data_type, self.generator_id, self.discriminator_id, self.activation,
                          self.num_epochs, datetime.now().strftime("%d%m%Y-%H%M%S")))
        torch.save(self.x_fake_test.detach(), "/content/drive/MyDrive/ColabNotebooks/Code_RSig_Gen/Conditional_Generator/best_generators/{}/{}-{}-{}-{}-{}-train.pt".
                   format(self.data_type, self.generator_id, self.discriminator_id, self.activation,
                          self.num_epochs, datetime.now().strftime("%d%m%Y-%H%M%S")))
        torch.save(self.x_train.detach(), "/content/drive/MyDrive/ColabNotebooks/Code_RSig_Gen/Conditional_Generator/best_generators/{}/{}-{}-{}-{}-{}-test.pt".
                   format(self.data_type, self.generator_id, self.discriminator_id, self.activation,
                          self.num_epochs, datetime.now().strftime("%d%m%Y-%H%M%S")))
    ...
    def plot_paths(self, num_paths=50):
        ...
        plt.show()
        fig.savefig("/content/drive/MyDrive/ColabNotebooks/Code_RSig_Gen/Conditional_Generator/best_generators/{}/{}-{}-{}-{}-{}-plot.pdf".
